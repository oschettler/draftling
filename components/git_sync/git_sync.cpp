...
/* Mbed TLS 4.x (ESP-IDF 6.x) removed the legacy `mbedtls/sha1.h`
 * low-level API in favour of PSA Crypto (see the ESP-IDF 6.0
 * security migration guide). Use psa/crypto.h for the git blob
 * SHA-1 helper. */
