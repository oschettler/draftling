 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --font greybeard/Greybeard-16px.ttf -r 0x20-0x7F,0xA0-0xFF,0x400-0x4FF --size 16 --bpp 1 --format lvgl --no-compress --lv-font-name greybeard_16 -o greybeard_16.c
 ******************************************************************************/
